...
(normal_command
  ...
  (#match? @keyword.repeat "\\b^(continue|break)$"))

(normal_command
  (identifier) @keyword.return
  (#match? @keyword.return "\\b^return$"))
...
;
((argument) @boolean
  (#match? @boolean "\\b^(1|on|yes|true|y|0|off|no|false|n|ignore|notfound|.*-notfound)$"))
